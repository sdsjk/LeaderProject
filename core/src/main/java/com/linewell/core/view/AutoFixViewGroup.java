 ...
 * @since 2016/9/7.
 */
public class AutoFixViewGroup extends ViewGroup{
    /**
     * 存储所有的View，按行记录
     * 每个item就是记录的每行的view
     */
    ...
    public AutoFixViewGroup(Context context) {
        super(context);
    }

    public AutoFixViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoFixViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for(int i=0; i<childSize; i++) {
            ...
            if(layoutParams instanceof MarginLayoutParams){
                ...
                lp = new MarginLayoutParams(layoutParams);
            }
        ...
        for(int j=0; j<linesNumber; j++) {
            ...
            for(int n=0; n<lineNumbers; n++) {
                ...
                if(view.getLayoutParams() instanceof MarginLayoutParams){
                    ...
                    lp = new MarginLayoutParams(view.getLayoutParams());
                }
