...
public class DoubleLineChatView extends View {
    ...
    public DoubleLineChatView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //柱状图的宽度
        mLineWidth = array.getDimension(R.styleable.DoubleLineChatView_chatview_line_width, dip2px(mContext, 20));
        //左边柱状图的背景色
        ...
        //XY轴的字体大小
        mLineXYSize = array.getDimension(R.styleable.DoubleLineChatView_chatview_text_xy_size, sp2px(mContext, 10));
        //两组柱状图之间的距离（偏大距离）
        ...
        isshowone = array.getBoolean(R.styleable.DoubleLineChatView_isshowone, false);
        //柱状图生长动画时间，默认1秒
