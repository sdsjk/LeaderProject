...
public class NormalJsonObjectRequest extends JsonRequest<JsonObject> {
    ...
    private void initHeaders(Listener<JsonObject> listener){
     ...
     *
     * @see #NormalJsonObjectRequest(int, String, JsonObject, Listener, ErrorListener)
     */
    public NormalJsonObjectRequest(String url, JsonObject jsonRequest, Listener<JsonObject> listener,
