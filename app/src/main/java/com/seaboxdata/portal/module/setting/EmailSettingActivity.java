...
public class EmailSettingActivity extends CommonActivity {
    //    标题
    ...
    @OnClick(R.id.setting_safe_next)
    public void settingSafeNext() {
        startActivity(new Intent(this,EmailFinshActivity.class));
    }
